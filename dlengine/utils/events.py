...
class CommonMetricPrinter(EventWriter):
    ...
    def write(self):
        ...
        self.logger.info(
            " {eta}epoch: {epoch}/{end_epoch} iter: {iter}  {losses}  {time}{data_time}lr: {lr}  {memory}".format(
...
class EventStorage:
    ...
    def __init__(self, start_iter=0, start_epoch=0, end_epoch=0, iters_per_epoch=0):
        """
        Args:
